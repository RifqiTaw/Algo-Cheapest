...
def main(tourid,idhotel,dwaktu,drating,dtarif):
    ...
    i = 0
    while i < 3 and tur:
        cs = CuckooSearch(tour= tur, pa = 0.1, sarang = 200, maxgenerasi = 100, timematrix= timematrix, tmhotelfrom= tmhotelfrom, tmhotelto= tmhotelto, hotel= hotel, drating=drating, dtarif=dtarif, dtime=dwaktu)
        tsp,rest = cs.tsp()
        tur = rest
        for node in tsp:
...
if __name__ == '__main__':
    tsp,waktudatang = main([1,2,3,5,6,7,13,15,16,17,18,19,20,21,22,23,25,26,27,28],32,1,1,1)
